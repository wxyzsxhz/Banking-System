...
public class fail_Loading extends javax.swing.JFrame implements Runnable {
    
    Thread th;
    private String loginData;
    private String signupData;
    public fail_Loading(String loginData,String signupData) {
         ...
         try{
           for (int i=0;i<=101  ;i++){
               ...
               if (v<m){
                   ...
                   i=101;
                    setVisible(false);
                   Transcatiion_Fail tf=new Transcatiion_Fail(loginData,signupData);
                   tf.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Processing On Your Payment...");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 190, -1));

        jProgressBar1.setBackground(new java.awt.Color(204, 204, 204));
        jProgressBar1.setForeground(new java.awt.Color(52, 73, 94));
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 250, 10));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fail_Loading(null,null).setVisible(true);
            }
        });
